 ...
 */
package object precisiondouble extends ImplicitMathContext {
  ...
  type ReadDoubleRef = precisiondoublex.ReadDoubleRef
  type DoubleRef = precisiondoublex.DoubleRef
  val DoubleRef = precisiondoublex.DoubleRef
  val functions = precisiondoublex.functions
