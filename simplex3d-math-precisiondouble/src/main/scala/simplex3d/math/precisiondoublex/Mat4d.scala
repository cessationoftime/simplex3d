...
with Protected with Serializable
{
  ...
  final def apply(c: Int) :ConstVec4d = {
    c match {
      ...
      case 3 => new ConstVec4d(m30, m31, m32, m33)
                      ...
                      41 * (
                        41 * (
                          41 * (
                            ...
                            ) + simplex3d.math.doubleHashCode(m03)
                          ) + simplex3d.math.doubleHashCode(m10)
                        ) + simplex3d.math.doubleHashCode(m11)
                      ) + simplex3d.math.doubleHashCode(m12)
                    ) + simplex3d.math.doubleHashCode(m13)
                  ) + simplex3d.math.doubleHashCode(m20)
                ) + simplex3d.math.doubleHashCode(m21)
              ) + simplex3d.math.doubleHashCode(m22)
            ) + simplex3d.math.doubleHashCode(m23)
          ) + simplex3d.math.doubleHashCode(m30)
        ) + simplex3d.math.doubleHashCode(m31)
      ) + simplex3d.math.doubleHashCode(m32)
    ) + simplex3d.math.doubleHashCode(m33)
  }
...
object Mat4d {
  ...
  final val Tag = classTag[Mat4d]
  final val ConstTag = classTag[ConstMat4d]
  final val ReadTag = classTag[ReadMat4d]
