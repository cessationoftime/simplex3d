 ...
 */
package object precisionsingle extends ImplicitMathContext {
  ...
  type ReadFloatRef = precisionsinglex.ReadFloatRef
  type FloatRef = precisionsinglex.FloatRef
  val FloatRef = precisionsinglex.FloatRef
  val functions = precisionsinglex.functions
