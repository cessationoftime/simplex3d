...
class Mat4x3fTest extends FunSuite {
  ...
  test("Factories") {
    ...
    expectResult((f30, f31, f32)) { (m.m30, m.m31, m.m32) }
    ...
    expectResult((f10, f11, 0)) { (m.m10, m.m11, m.m12) }
    expectResult((f20, f21, 1)) { (m.m20, m.m21, m.m22) }
    expectResult((f30, f31, 0)) { (m.m30, m.m31, m.m32) }
    ...
    expectResult((toFloat(d30), toFloat(d31), toFloat(d32))) { (m.m30, m.m31, m.m32) }
    ...
    expectResult((toFloat(d10), toFloat(d11), 0)) { (m.m10, m.m11, m.m12) }
    expectResult((toFloat(d20), toFloat(d21), 1)) { (m.m20, m.m21, m.m22) }
    expectResult((toFloat(d30), toFloat(d31), 0)) { (m.m30, m.m31, m.m32) }
